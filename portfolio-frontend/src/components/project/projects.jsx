...
function Projects(props) {
  ...
  const defaultProjects = [
    ...
    },
    {
      ...
      desc: "A real-time chat application built with secure user authentication and instant messaging features. Users can register, log in, join chat rooms, and exchange messages in real time. Implemented WebSocket-based communication for seamless live chatting, with typing indicators, online/offline user status, and message timestamps.",
      tags: [
        "Node.js",
        "Express.js",
        "MongoDB",
